...
def classify(benchmark):
    ...
    for tx in txList:
        ...
        if tx_category == None:
            ...
            sys,exit("tx_category is None for tx ", tx)
            continue
    ...
    for tx_category in categoryCounts:
        ...
        for tx in categoryCounts[tx_category]:
            ...
            if tx_category != 6:
                ...
                totalGasWithGuard += numEntries * gasConsumptionGuard["ValidatePre"]
                totalGasWithGuard += numExits * gasConsumptionGuard["ValidatePost"]
            ...
            # Prune Hard: Read-After-Write. 
                ...
                if tx_category == 6:
                    print("before pruneRAW: ", str(results))
                    print("tx: ", tx)
...
def executeOnce(listBenchmark, local_pruneRuntimeReadOnly,  local_pruneCache,  local_pruneRAW, local_pruneParametric2):
...
if __name__ == "__main__":
    ...
    # executeOnce(listBenchmark, True, True, True, True, 267)
    executeOnce(listBenchmark, args.pruneRuntimeReadOnly, args.pruneCache, args.pruneRAW, args.pruneParametric2)
    # for benchmark in listBenchmark:
    #     staticcall_functions = []
    #     complementary_functions_nonReadOnly2ReadOnly = []
    #     complementary_functions_close_source = []
