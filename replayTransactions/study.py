...
if __name__ == "__main__":
    ...
    # ifPrint = True when working on RQ1, when we set pruneTrivialControlFlow = False
    # ifPrint = False when working on RQ3, when we set pruneTrivialControlFlow = True
    isPrint = True
    ...
    for benchmark in listBenchmark:
        ...
        if isPrint:
            SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
            folderPath = SCRIPT_DIR + "/figures11_finalized_0918_2/"
